 ...
 */
sap.ui.define([
'sap/base/util/ObjectPath'], function (O) {
  'use strict';
  ...
  var s = function () {
    ...
    'sap/m/ColorPalettePopover'], function (m, B, o, c, S, M, d, e, t, f, g, D, L, h, i, H, v, T, j, I, k) {
      library.RichTextEditorHelper = {bSapMLoaded:true};
      _.Button = B;
      _.OverflowToolbarButton = o;
      _.OverflowToolbarToggleButton = c;
      _.SplitButton = S;
      _.MenuButton = M;
      _.Menu = d;
      _.Select = e;
      _.ToolbarSeparator = t;
      _.OverflowToolbar = f;
      _.OverflowToolbarLayoutData = g;
      _.MenuItem = m;
      _.Dialog = D;
      _.Label = L;
      _.CheckBox = h;
  ...
  O.set('cmjs.richtexteditor.RichTextEditorHelper', {
    bSapMLoaded: false,
    createOverflowToolbar: function (i, c) {
      return a('OverflowToolbar', {
        id: i,
        content: c
      });
    },
    createInvisibleText: function (c) {
      return a('InvisibleText', c);
    },
    createButton: function (c) {
      c.type = sap.m.ButtonType.Transparent;
      return a('Button', c);
    },
    createOverflowToolbarButton: function (c) {
      c.type = sap.m.ButtonType.Transparent;
      return a('OverflowToolbarButton', c);
    },
    createSplitButton: function (c) {
      c.type = sap.m.ButtonType.Default;
      return a('SplitButton', c);
    },
    createOverflowToolbarToggleButton: function (c) {
      c.type = sap.m.ButtonType.Transparent;
      return a('OverflowToolbarToggleButton', c);
    },
    createMenuButton: function (i, I, f, c, t) {
      return a('MenuButton', {
        layoutData: a('OverflowToolbarLayoutData', {
    ...
    createToggleButton: function (c) {
      c.layoutData = a('OverflowToolbarLayoutData', {
        priority: sap.m.OverflowToolbarPriority.NeverOverflow
      });
      c.type = sap.m.ButtonType.Transparent;
      return a('ToggleButton', c);
    },
    createToolbarSeparator: function () {
      return a('ToolbarSeparator');
    },
    createSelect: function (c) {
      return a('Select', c);
    },
    ...
    createCheckBox: function (c) {
      return a('CheckBox', c);
    },
    createDialog: function (c) {
      return a('Dialog', c).addStyleClass('sapUiPopupWithPadding');
    },
    createText: function (c) {
      return a('Text', c);
    },
    createHBox: function (c) {
      return a('HBox', c);
    },
    createVBox: function (c) {
      return a('VBox', c);
    },
    createStepInput: function (c) {
      return a('StepInput', c);
    },
    createColorPalettePopover: function (c) {
      return a('ColorPalettePopover', c);
    }
  });
  if (sap.ui.getCore().getLoadedLibraries() ['sap.m']) {
    ...
    var b = function (e) {
      ...
      if (E.stereotype === 'library' && E.name === 'sap.m') {
        setTimeout(s.bind(null), 0);
        setTimeout(sap.ui.getCore() ['detachLibraryChanged'].bind(sap.ui.getCore(), b), 0);
      }
    };
    sap.ui.getCore().attachLibraryChanged(b);
  }
  return library;
});
//# sourceURL=http://localhost:8080/admin/resources/sap/ui/richtexteditor/library.js?eval
